...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-50 mb-50" style="background:none; border:0;">
                <div class="card-header" style="background:none; border:0; font-size:28px; font-weight:600;">{{ __('Login') }}</div>
