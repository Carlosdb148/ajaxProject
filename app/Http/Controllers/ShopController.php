...
class ShopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $ordercategory = $this->getOrderCategory($request->input('ordercategory'));
        ...
        $shop = $shop->orderBy($orderby, $ordertype);
        ...
        return view('shop.index', ['order'  => $this->getOrderUrls($orderby, $ordertype, $ordercategory , $q, 'shop.index'),
                                    'q'     => $q,
    ...
    public function viewChart(){
        return view('chart.index', ['charts' => $this->charts]);
    }
