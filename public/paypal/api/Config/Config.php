...
define("URL", array(
	...
	"redirectUrls" => array(
        "returnUrl" => 'paypal/pages/success.php',
		"cancelUrl" => 'paypal/pages/cancel.php',
    )
));
...
define("PAYPAL_CREDENTIALS", array(
	"sandbox" => [
		...
		"client_id" => "AUB9Bz3Sv9iZl3vsDtVKTxH0FU_QUH0RMyvPJ_99_-4d79sBXGFuztIMCD9kCU8DfZfn3n2NLooBWYVR",
		"client_secret" => "EDo7_BnuYdO3FlNC5QvVlCnAXrrarj-cVBvwzCrULKqmj9Z3HZVjJmyRQg49AUhslwvRikOgSHRFJG9z"
	],
	"production" => [
		"client_id" => "",
		"client_secret" => ""
