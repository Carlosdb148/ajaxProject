                ...
                body : JSON.stringify(
                    {
                        ...
                        'idaccount' : result.payment_source.paypal.account_id, 
                        'value' : result.purchase_units[0].payments.captures[0].amount.value, 
                        'currencycode' : result.purchase_units[0].payments.captures[0].amount.currency_code
                    }
                )
            })
            .then(function(response) {
